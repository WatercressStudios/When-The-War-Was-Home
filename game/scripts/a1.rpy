...
label a1:
    ...
    ric surprised "Is it on the news already or you're too cynical to consider I'm calling just to check on a friend?"
    mc "I assume both are true, but I skim the entertainment section."
    ric pleased "Hahaha, ouch, real cold-blooded. Read my bluff without a second thought."
    ...
    #*clap sfx*
    ric smile "Marvelous! Be there in a flash hon!"
    #*click sfx*
    ...
    "Right on cue."
    #show ric
    ric shout "Dooooooc! It's been too long! Come here!"
    #*grip sfx*
    ...
    #*pistons sfx*
    ric surprised "Oh, oh god! My bad Doc, it's been nothing but androids around me this past week, kinda forgot to tone it down."
    ...
    ric neutral "Yeah, I got three labels that want to purchase the rights for this one, and two others looking into a contract for me to design their fall armor collection."
    ...
    ric pleased "Hahahaha, you’re not wrong! But that’s stardom baby, ain’t nothing easy in this world!"
    ric neutral "I’ve got enough sketches laying around to give them a taste of what’s to come. Worst case I’ll just give up a few nights of sleep to crank them all out."
    mc "Careful Icarus, try to have it all and you might end up with none."
    "Richter flaunts his cape magnanimously."
    ric pleased "Nonsense! The Richter brand is synonymous with perfection for a reason! Anything else won’t see the light of day!"
    ...
    ric sad "Umm... can I look for the sander instead? My shoulder’s been acting up lately."
    ...
    ric dm groan  "About that… c-can we leave that in?"
    ...
    ric dm frown "Western maneuver of Operation Phalanx. Move to defensive positions in a border town and prepare for a possible siege."
    ...
    ric dm groan "I-I want... I don't know. I wish things were different."
    ...
    ric neutral "Thank you, Doctor."
    mc "Com’on, Ric. Doc doesn’t need formality"
    ric pleased "Hehe, maybe so, but you at least deserve it."
